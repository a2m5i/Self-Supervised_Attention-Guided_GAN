...
parser.add_argument("--cityscapes_dir", type=str, required='./datasets/cityscapes/testA', help="Path to the original cityscapes dataset")
parser.add_argument("--result_dir", type=str, required='./datasets/cityscapes/testB', help="Path to the generated images to be evaluated")
parser.add_argument("--output_dir", type=str, required='./results/cityscapes_attentiongan/Rot_d=0.0/test_latest/images/fakeB', help="Where to save the evaluation results")
